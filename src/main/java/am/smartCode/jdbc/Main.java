...
//
//        //GET all users
//        List<am.smartCode.jdbc.model.User> allUsers = userRepository.getAll();
//        for (am.smartCode.jdbc.model.User allUser : allUsers) {
