...
public class ProductRepositoryImpl implements ProductRepository {
    ...
    private void setProductFields(Product product, ResultSet resultSet) throws SQLException {
        product.setId(resultSet.getLong(Strings.ID));
        product.setCategory(resultSet.getString(Strings.CATEGORY));
        product.setName(resultSet.getString(Strings.NAME));
        product.setPrice(resultSet.getLong(Strings.PRICE));
    }
